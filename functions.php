...
function grupofadiar_assets() {
    ...
    wp_enqueue_script('grupofadiar-products', get_template_directory_uri() . '/assets/js/products.js', array(), filemtime(get_template_directory() . '/assets/js/products.js'), true);
    ...
    wp_enqueue_script('grupofadiar-support-carousel', get_template_directory_uri() . '/assets/js/support-carousel.js', array(), filemtime(get_template_directory() . '/assets/js/support-carousel.js'), true);
    ...
    wp_enqueue_script('grupofadiar-modal-category', get_template_directory_uri() . '/assets/js/modal-category.js', array(), filemtime(get_template_directory() . '/assets/js/modal-category.js'), true);
