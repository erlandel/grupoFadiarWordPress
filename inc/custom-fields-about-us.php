    ...
    if (function_exists('acf_add_local_field_group')):
        ...
        acf_add_local_field_group(array(
            ...
            'fields' => array(
                ...
                array(
                    'key' => 'field_about_metrics_image_mobile',
                    'label' => 'Imagen del bloque metrics para móvil',
                    'name' => 'about_metrics_image_mobile',
                    'type' => 'image',
                    'instructions' => 'Imagen mostrada hasta 767px. Si se deja vacía, se usa la imagen de tablet y PC.',
                    'required' => 0,
                    'return_format' => 'array',
                    'preview_size' => 'large',
                    'library' => 'all',
                ...
                array(
                    ...
                    'label' => 'Imagen del bloque metrics para tablet y PC',
                    'name' => 'about_metrics_image',
                    'type' => 'image',
                    'instructions' => 'Imagen mostrada desde 768px. Si se deja vacía, se usa el asset por defecto (assets/images/about/about.png).',
                    'required' => 0,
                    'return_format' => 'array',
                    'preview_size' => 'large',
                    'library' => 'all',
