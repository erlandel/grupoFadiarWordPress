...
<div class="group relative flex flex-col w-73 h-90.5 bg-white/5 rounded-xl p-4 overflow-hidden transform transition-transform duration-300 hover:scale-115">
  ...
  <div class="flex flex-col justify-center items-center grow group-hover:opacity-0 transition-opacity duration-300">
    <img src="<?php echo esc_url($args['brandImage']); ?>" alt="<?php echo esc_attr($args['brandAlt']); ?>" width="<?php echo esc_attr($args['brandWidth']); ?>" height="<?php echo esc_attr($args['brandHeight']); ?>" class="object-contain" />
  </div>
  <div class="absolute inset-0 bg-white/1 flex flex-col items-center justify-start p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl">
    <div class="flex mb-4">
      <img src="<?php echo esc_url($args['brandImage']); ?>" alt="<?php echo esc_attr($args['brandAlt']); ?>" width="<?php echo esc_attr($args['brandWidth']); ?>" height="<?php echo esc_attr($args['brandHeight']); ?>" class="object-contain" />
    </div>
    <p class="text-white text-lg leading-relaxed"><?php echo esc_html($args['description']); ?></p>
  </div>
</div>
