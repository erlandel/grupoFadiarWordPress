...
<section id="supportHome" class="scroll-mt-24 w-full py-16 px-4 bg-white">
  <div class="mx-30">
    <div class="text-center mb-16">
      <h3 class="reveal-item text-secondary font-semibold text-2xl mb-4"><?php echo esc_html($section_title); ?></h3>
      <h2 class="reveal-item text-3xl md:text-4xl font-black text-dark mb-8"><?php echo esc_html($section_subtitle); ?></h2>
    </div>
    <?php if ($support_items): ?>
    <div data-reveal-pairs="2" class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      ?>
        <div class="reveal-item flex gap-4">
