...
?>
<header class="site-header w-full z-50 transition-colors duration-300 <?php echo $is_home_page ? 'fixed bg-white/40 backdrop-blur-sm shadow-lg' : 'sticky top-0 bg-white/30 backdrop-blur-md shadow-lg'; ?>">
