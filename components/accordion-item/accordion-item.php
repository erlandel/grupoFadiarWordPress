...
<div class="accordion-item w-full rounded-lg shadow-xl cursor-pointer transition-all duration-300 bg-white text-dark">
  ...
  <div class="accordion-content hidden p-6 pt-0 text-white text-lg ">
        ...
        <?php foreach ($leaders as $leader): ?>
          <li class="flex flex-col py-4 first:pt-0">
            <div class="flex items-start gap-4">
              ...
              <div class="flex flex-col gap-2">
                <span class="font-bold text-xl"><?php echo esc_html($leader['name']); ?></span>
                <div class="text-lg text-white/80"><?php echo wp_kses_post($leader['shortDescription']); ?></div>
              </div>
            </div>
            <div class="mt-4 text-lg text-white/80"><?php echo wp_kses_post($leader['fullDescription']); ?></div>
          </li>
        <?php endforeach; ?>
      </ul>
