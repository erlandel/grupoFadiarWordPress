...
<div class="relative md:col-span-2" data-phone-input>
    ...
    <div class="flex flex-col">
      <?php foreach ($countries as $c): ?>
        <label class="flex items-center gap-3 py-3 px-6 border-b-3 border-[#EDEDED] last:border-0 cursor-pointer text-xl text-dark hover:bg-gray-200 rounded transition-colors"
               ...
               data-country-name="<?php echo esc_attr($c['name_es']); ?>"
          ...
          <span class="font-normal"><?php echo esc_html($c['name_es']); ?></span>
          <span class="ml-auto text-dark/60"><?php echo esc_html($c['phoneCode']); ?></span>
        </label>
      <?php endforeach; ?>
    </div>
    <p data-phone-empty class="hidden text-center py-6 text-dark/60">No se encontraron países</p>
  </div>
  ...
  <p data-error class="hidden text-sm text-red-500 mt-1 ml-2">Ingresa un número de teléfono válido</p>
</div>
