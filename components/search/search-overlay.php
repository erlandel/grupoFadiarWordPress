<div class="search-overlay hidden">
  ...
  <div class="search-panel-wrapper fixed left-0 right-0 z-70 px-4 pointer-events-none bottom-4 md:bottom-6 max-h-[calc(100vh-var(--header-h)-2rem)] overflow-hidden">
    <div class="search-panel max-w-2xl mx-auto bg-white/40 backdrop-blur-2xl rounded-xl shadow-2xl pointer-events-auto flex flex-col overflow-hidden">
