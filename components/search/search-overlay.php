<div class="search-overlay hidden">
  ...
  <div class="search-panel-wrapper fixed left-0 right-0 z-70 px-2 sm:px-4 pointer-events-none bottom-2 md:bottom-6 max-h-none md:max-h-[min(65vh,calc(100vh-var(--header-h)-2rem))] overflow-hidden">
    <div class="search-panel max-w-2xl mx-auto bg-white/40 backdrop-blur-2xl rounded-xl shadow-2xl pointer-events-auto flex flex-col max-h-full overflow-hidden">
      ...
      <div class="px-4 sm:px-6 md:px-8 pb-4 md:pb-6 shrink-0">
        <div class="relative">
          ...
          <input
            type="text"
            class="search-input w-full pl-12 md:pl-14 pr-4 py-3 md:py-4 text-base md:text-xl bg-transparent border-b-2 border-dark/20 focus:border-dark outline-none text-dark placeholder:text-dark/30 font-montserrat transition-colors duration-300"
      ...
      <div class="hidden md:flex px-4 sm:px-6 md:px-8 pb-4 md:pb-6 shrink-0 gap-2 md:gap-3 overflow-x-auto search-filters scrollbar-hide">
      ...
      <div class="search-suggestion-hint hidden px-4 sm:px-6 md:px-8 pb-3 md:pb-4 text-sm text-dark/50" role="status"></div>

      <div class="search-results px-4 sm:px-6 md:px-8 pb-5 md:pb-8 flex-1 min-h-0 overflow-y-auto">
