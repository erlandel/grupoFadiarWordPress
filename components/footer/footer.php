...
$legal_links = array(
  array('name' => 'Política de privacidad', 'href' => '#'),
  array('name' => 'Uso de cookies', 'href' => '#'),
  array('name' => 'Condiciones de uso', 'href' => '#'),
  array('name' => 'Ventas y reembolsos', 'href' => '#'),
  array('name' => 'Avisos legales', 'href' => '#'),
  array('name' => 'Mapa del sitio', 'href' => '#'),
);
?>
    ...
    <div class="flex flex-col lg:col-span-1">
      <div>
        ...
        <div class="flex gap-8 mb-8">
          ...
          <a href="#" aria-label="Correo electrónico">
      ...
      <div class="flex flex-col items-start">
        ...
        <ul class="space-y-2">
          <?php foreach ($section['links'] as $link): ?>
            <li>
              <a href="<?php echo esc_url($link['href']); ?>" class="text-lg hover:text-secondary transition-colors">
