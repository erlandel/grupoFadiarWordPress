    ...
    <div class="flex justify-between items-end mt-2">
      <div class="w-1/2 text-2xl text-dark font-bold">
        <div class="flex flex-col  gap-8">
          <h1 class="reveal-item text-4xl font-bold text-dark"><?php echo esc_html(gf_get_option('support_warranty_title', 'Soporte y Garantía', 'Support and Warranty')); ?></h1>
          <h2 class="reveal-item"><?php echo esc_html(gf_get_option('support_warranty_subtitle', 'Atención técnica y reclamaciones', 'Technical support and claims')); ?></h2>
        </div>
      </div>
      <?php get_template_part('components/support-header/support-header'); ?>
    </div>
    <div class="reveal-item mt-10 text-dark text-lg">
...
<div class="reveal-section my-40 overflow-hidden">
  <?php get_template_part('components/support-carousel/support-carousel'); ?>
</div>

<div class="reveal-section my-20">
