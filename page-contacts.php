...
<div class="mx-30 mt-7">
  ...
  <div class="mt-7">
    <h1 class="text-4xl font-bold text-dark"><?php echo esc_html(gf_get_option('contact_page_title', 'Contáctanos', 'Contact Us')); ?></h1>
    <p class="mt-4 text-2xl text-dark">
...
<div class="mx-30 mt-10 mb-10 max-w-2xl">
