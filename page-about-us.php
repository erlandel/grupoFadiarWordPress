...
<div class="reveal-section"><?php get_template_part('components/metrics/metrics', null, array('post_id' => $about_id)); ?></div>
<div class="reveal-section"><?php get_template_part('components/our-story/our-story'); ?></div>
<div class="reveal-section"><?php get_template_part('components/corporate-pillars/corporate-pillars'); ?></div>
