      ...
      <div data-filter-modal class="fixed inset-0 z-100 hidden items-center justify-center  bg-black/40">
        <div class="bg-[#F8F8F8] rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden" role="dialog" aria-modal="true" aria-labelledby="filter-modal-title">
          <div class="flex items-center justify-between px-6 pt-6 pb-4">
            <h2 id="filter-modal-title" class="text-2xl font-bold text-dark"><?php echo esc_html(gf_e('noticias.filter_categories')); ?></h2>
          ...
          <form method="get" action="<?php echo esc_url($base_url); ?>" class="px-6 pb-6" data-filter-form>
            <div class="flex flex-col ">
              <label class="flex items-center gap-4 py-4 px-2 -mx-2 border-b-3 border-[#EDEDED] cursor-pointer text-xl text-dark hover:bg-gray-200 rounded transition-colors">
              ...
              <?php foreach ($categories as $cat): ?>
                <label class="flex items-center gap-4 py-4 px-2 -mx-2 border-b-3 border-[#EDEDED] last:border-0 cursor-pointer text-xl text-dark hover:bg-gray-200 rounded transition-colors">
